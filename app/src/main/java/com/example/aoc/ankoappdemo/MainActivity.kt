...
////            Request().run()
//            Log.d("dddd", text1)
//            name.hint = "[{\"id\":\"1\",\"name\":\"三国演义\",\"author\":\"罗贯中\"}]"
//
//            val bean = Gson().fromJson("[{\"id\":\"1\",\"name\":\"三国演义\",\"author\":\"罗贯中\"}]", Book::class.javaObjectType)
//            Log.d("aaa", bean.author)
//
//
////            val t = Gson().fromJson<List<Book>>("[{\"id\":\"1\",\"name\":\"三国演义\",\"author\":\"罗贯中\"}]")
//
//            uiThread {
//              // longToast("123123")
//            }
